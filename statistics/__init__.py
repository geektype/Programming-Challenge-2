...
def _decimal_to_ratio(d):
    u"""Convert Decimal d to exact integer ratio (numerator, denominator).
    ...
    if exp in (u'F', u'n', u'N'):  # INF, NAN, sNAN
...
def _ss(data, c=None):
    ...
    assert not ss < 0, u'negative sum of square deviations: %f' % ss
    return ss
